"""
parserdata_extract_schema_json.py
------------------
Batch-extract structured data from invoice PDFs and images using the Parserdata API.
Uses schema-based extraction for consistent, pipeline-ready JSON output.
...
Usage:
    ...
    2. Run:  parserdata_extract_schema_json.py
"""
...
# Schema-based extraction: define exactly the fields you want returned.
# This guarantees a consistent structure every run.
# Edit field names and types to match your needs.
SCHEMA = {
    ...
    "line_items":     "table",   # rows with description, qty, unit price, total
    "subtotal":       "number",
    "tax_amount":     "number",
    "total_amount":   "number",
